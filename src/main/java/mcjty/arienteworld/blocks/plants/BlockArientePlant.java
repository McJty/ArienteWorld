...
public class BlockArientePlant extends BlockBush implements net.minecraftforge.common.IShearable {
    ...
    public BlockArientePlant(String name) {
        ...
        setCreativeTab(ArienteWorld.setup.getTab());

        setUnlocalizedName(ArienteWorld.MODID + "." + name);
        setRegistryName(name);
        McJtyRegister.registerLater(this, ArienteWorld.instance, ItemBlock::new);
    }
